...
class BallView(context: Context?) : View(context){
    ...
    fun init() {
        ...
        // ボール接触音 をロードしておく
        soundTouch = soundPool.load(context, R.raw.touch1, 1)

        // 爆発音 をロードしておく
        soundExplosion = soundPool.load(context, R.raw.expsound1, 1)
                ...
                if (target.id != ballNow) {
                    ...
                    if (len < ball.r + target.r) {
                        ...
                        if(ball.r > 500F) {
                            ...
                            soundPool.play(soundTouch, 1.0f, 1.0f, 1, 0, 1.0f)
                        }
                        break;
                    }
                }
